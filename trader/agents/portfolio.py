"""
Portfolio Agent — Portfolio-Manager from Owl Swarm.
Runs on: nvidia/nemotron-4-340b-instruct:free
"""
...
def run_cycle(client, llm, state) -> None:
    ...
    append_research(state, f"Portfolio: {resp.text[:240]}")
...
def main() -> None:
    agent_main(
        ...
        openrouter_model="nvidia/nemotron-4-340b-instruct:free",
    )
