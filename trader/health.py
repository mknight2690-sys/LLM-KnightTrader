...
def _pid_alive(pid: int) -> bool:
    ...
    if sys.platform == "win32":
        try:
            # Use WMI to check if process exists ΓÇö avoids Get-Process which hangs on zombies
    ...
    if TRADER_PID_FILE.is_file():
        try:
            ...
            if _pid_alive(old):
                ...
                # real trader process has a different PID ΓÇö clear stale non-trader locks.
